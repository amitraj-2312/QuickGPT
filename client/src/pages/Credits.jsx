  ...
  const fetchPlans = async () => {
   try {
      ...
      if (data.success){
        ...
        toast.error(data.message || 'Faild to plans.')
      }
   } catch (error){
         ...
         {plans.map((plan)=>(
            ...
            transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ? 
             ...
             <div className='flex-1'>
                ...
                mb-2'>{plan.name}</h3>
                <p className='text-2xl font-bold text-purple-600 dark:text-purple
                mb-4'>${plan.price}
             ...
             <button onClick={()=> toast.promise(purchasePlan(plan._id), {loading: 'processing...', success: 'Redirecting to payment...',
              error: 'Faild to purchase plan'
             })} 
